...
const CustomerServices = () => {
 ...
 activeTab === tab ? "bg-primary text-white shadow-lg shadow-primary/20" : "text-slate-400"
 )}
 >
 {tab}
 </button>
 ...
 <div 
 key={service.id} 
 className="card group bg-white border-none shadow-xl shadow-slate-100/50 overflow-hidden flex flex-col h-full"
 >
 ...
 <h3 className="text-xl font-black text-text-primary uppercase tracking-tight mb-2 ">{service.name}</h3>
 ...
 className="btn-primary h-11 px-6 rounded-xl flex items-center gap-2 font-black uppercase text-[10px] tracking-widest shadow-xl shadow-primary/20 "
 >
 ...
 <div className="relative w-full max-w-md bg-white rounded-[2rem] lg:rounded-[3rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in ">
 {showSuccess ? (
 ...
 className="w-10 h-10 bg-white rounded-xl shadow-sm text-slate-400 font-black "
 >
 -
 </button>
 ...
 className="flex-1 py-4 bg-slate-50 text-slate-500 rounded-2xl font-black uppercase tracking-widest text-[10px] "
 >
 Cancel
 </button>
 <button 
 type="submit"
 className="flex-[2] py-4 bg-primary text-white rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-xl shadow-primary/30 "
 >
 Confirm Request
 </button>
 </div>
