...
const CustomerOrders = () => {
 ...
 <div key={order.id} className="card p-5 lg:p-6 bg-white border-none shadow-xl shadow-slate-100/50">
 <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
 <div className="flex items-start gap-4 lg:gap-6">
 <div className="w-14 h-14 lg:w-16 lg:h-16 bg-slate-50 rounded-2xl flex items-center justify-center text-3xl shadow-inner">
 ...
 className="flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-100 rounded-xl text-[9px] font-black uppercase tracking-widest shadow-sm"
 >
 ...
 className="px-4 py-2.5 bg-rose-50 text-rose-500 rounded-xl text-[9px] font-black uppercase tracking-widest shadow-sm"
 >
 Cancel
 </button>
 )}
 ...
 className="flex items-center gap-2 px-4 py-2.5 bg-primary text-white rounded-xl text-[9px] font-black uppercase tracking-widest shadow-lg shadow-primary/20 "
 >
 ...
 <div className={cn("flex-1 rounded-full", (order.status === 'Cooking' || order.status === 'Ready') ? "bg-primary shadow-[0_0_10px_rgba(99,102,241,0.3)]" : "bg-slate-100", order.status === 'Cooking' && "opacity-40 ")} />
 ...
 <div className="relative w-full max-w-lg bg-white rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in ">
 ...
 <button onClick={() => setSelectedTrackOrder(null)} className="p-2 bg-white rounded-xl text-slate-300 ">
 <X className="w-6 h-6" />
 </button>
 </div>
 ...
 <step.icon className={cn("w-5 h-5", isCurrent && "")} />
 </div>
 <span className={cn(
 ...
 className="w-full py-5 bg-primary text-white rounded-3xl font-black uppercase tracking-widest text-[10px] shadow-2xl shadow-primary/30 "
 >
 Continue Shopping
 </button>
 </div>
