...
const CustomerMessages = () => {
 ...
 className="lg:hidden p-2 bg-white rounded-xl shadow-sm border border-slate-100 text-slate-400 mr-1"
 >
 ...
 <button className="p-3 bg-white border border-slate-100 rounded-2xl text-slate-400 shadow-sm"><Phone className="w-5 h-5" /></button>
 <button className="p-3 bg-white border border-slate-100 rounded-2xl text-slate-400 shadow-sm"><Video className="w-5 h-5" /></button>
 </div>
 </div>
 ...
 className="w-full pl-6 pr-32 py-5 bg-white border border-slate-100 rounded-[2rem] outline-none shadow-xl shadow-slate-200/20 text-sm font-bold focus:ring-4 focus:ring-primary/5 "
 />
 <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
 <button type="button" className="p-2.5 text-slate-300 "><ImageIcon className="w-5 h-5" /></button>
 <button 
 type="submit"
 disabled={!newMessage.trim()}
 className="w-12 h-12 bg-primary text-white rounded-2xl flex items-center justify-center shadow-lg shadow-primary/20 disabled:opacity-50 disabled:scale-100"
 >
