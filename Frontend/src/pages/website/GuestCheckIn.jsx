    ...
    <div className="min-h-screen bg-gradient-to-br from-[#bdf0e7] to-[#e0f7f3] flex flex-col items-center justify-center p-6 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md text-center flex flex-col items-center">
        ...
        <motion.div 
          ...
          className="w-24 h-24 bg-white rounded-[1.5rem] shadow-xl flex items-center justify-center mb-6"
        >
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl font-black text-[#2a2a2a] mb-2 tracking-tight">Gila House</h1>
          <p className="text-sm font-bold text-teal-700/60 uppercase tracking-widest">Hotel Guest Check-in</p>
        </motion.div>
        ...
        <motion.div 
          ...
          className="bg-white rounded-[2rem] p-8 md:p-10 shadow-2xl shadow-teal-900/5 w-full border border-white/50 text-left"
        >
          <p className="text-gray-400 text-[13px] font-medium leading-relaxed mb-8 text-center px-4">
            Select your room and enter your name to access the guest app — order food, view your bill, and request services.
          </p>

          <form className="space-y-6">
            <div>
              <label className="block text-[11px] font-black text-[#2a2a2a] uppercase tracking-widest mb-3">Select your room</label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-[11px] font-black text-[#2a2a2a] uppercase tracking-widest mb-3">First name</label>
              ...
              <div>
                <label className="block text-[11px] font-black text-[#2a2a2a] uppercase tracking-widest mb-3">Last name</label>
        ...
        >
          <Link to="/" className="text-[11px] font-bold text-teal-700/40 hover:text-teal-700 transition-colors flex items-center gap-1">
            <ArrowLeft size={12} /> Back to Gila House
          </Link>
          <Link to="/login" className="text-[11px] font-bold text-teal-700/40 hover:text-teal-700 transition-colors">
