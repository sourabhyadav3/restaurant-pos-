...
const CustomerMenu = () => {
 ...
 className="w-full pl-11 pr-5 py-3 bg-white border border-slate-100 rounded-xl lg:rounded-2xl outline-none shadow-sm text-sm font-bold focus:ring-4 focus:ring-primary/5 "
 />
 </div>
 </div>
 ...
 className={cn(
 "px-6 lg:px-8 py-2.5 rounded-xl text-[10px] lg:text-[11px] font-black uppercase tracking-widest border-2 whitespace-nowrap ",
 activeCategory === cat 
 ...
 className="card group cursor-pointer border-none shadow-xl shadow-slate-100/50 p-4 lg:p-5 bg-white flex flex-col h-full relative overflow-hidden"
 >
 {/* Veg/Non-Veg Badge */}
 ...
 <div className="h-40 lg:h-48 bg-slate-50 rounded-[2rem] flex items-center justify-center text-6xl mb-5 shadow-inner relative ">
 {item.image}
 <button 
 ...
 <h4 className="font-black text-text-primary text-sm lg:text-base uppercase tracking-tight leading-tight ">{item.name}</h4>
 ...
 <button 
 className="w-10 h-10 lg:w-12 lg:h-12 bg-primary text-white rounded-2xl flex items-center justify-center shadow-xl shadow-primary/30 "
 >
 ...
 />
 <div className="relative w-full max-w-lg bg-white rounded-[2rem] lg:rounded-[3rem] shadow-2xl overflow-hidden self-end lg:self-center flex flex-col max-h-[90vh] animate-in fade-in slide-in-from-bottom-4 ">
 {/* Header / Image Area */}
 <div className="relative h-48 sm:h-56 lg:h-64 bg-slate-50 flex items-center justify-center text-7xl lg:text-9xl shrink-0">
 {selectedItem.image}
 <button 
 onClick={() => setShowItemModal(false)}
 className="absolute top-4 sm:top-6 right-4 sm:right-6 p-2.5 sm:p-3 bg-white/80 backdrop-blur-md rounded-2xl text-slate-400 shadow-xl "
 >
 ...
 className={cn(
 "flex-1 min-w-[70px] sm:min-w-[80px] px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl lg:rounded-2xl border-2 text-center",
 ...
 className="w-9 lg:w-10 h-9 lg:h-10 bg-white rounded-xl flex items-center justify-center text-slate-400 shadow-sm "
 >
 ...
 className="w-full px-4 lg:px-5 py-3 lg:py-3.5 bg-slate-50 rounded-xl lg:rounded-2xl text-[11px] lg:text-xs font-bold outline-none border-2 border-transparent focus:border-primary/20 "
 />
 </div>
 </div>
 </div>
 ...
 className="w-full btn-primary py-4 lg:py-5 rounded-2xl lg:rounded-3xl flex items-center justify-center gap-3 text-xs lg:text-sm font-black uppercase tracking-widest shadow-2xl shadow-primary/30 group"
 >
 <ShoppingBag className="w-5 h-5 " /> Add to Order • ₹{selectedSize.price * quantity}
 </button>
 </div>
 </div>
 </div>
