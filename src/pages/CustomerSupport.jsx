...
const CustomerSupport = () => {
 ...
 const faqs = [
 { q: 'How do I call a waiter?', a: 'You can use the "Call Waiter" button at the top of the Support Hub for instant assistance.' },
 ...
 className="card p-6 bg-white border-none shadow-xl shadow-slate-100/50 group cursor-pointer relative overflow-hidden"
 >
 {channel.badge && (
 ...
 <div className={cn("w-14 h-14 rounded-2xl flex items-center justify-center mb-6 shadow-sm ", channel.color)}>
 ...
 <div className="flex items-center gap-4">
 <span className="text-[9px] font-black text-slate-300 uppercase tracking-widest hidden sm:block">{new Date(req.createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
 <button 
 onClick={() => alert(`Viewing details for request #${req.id}`)}
 className="px-4 py-2 bg-slate-50 rounded-xl text-[9px] font-black uppercase tracking-widest "
 >
 View Details
 </button>
 </div>
 ...
 key={faq.q} 
 onClick={() => alert(faq.a)}
 className="p-6 bg-white rounded-3xl shadow-sm border border-slate-50 group cursor-pointer"
 >
 ...
 className="p-6 bg-slate-50 text-text-primary border border-slate-100 rounded-[2rem] shadow-xl shadow-slate-100 relative overflow-hidden group cursor-pointer min-h-[160px] flex flex-col justify-between"
 >
 <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full -mr-16 -mt-16 blur-2xl" />
 <Globe className="w-10 h-10 mb-4 text-primary " />
 <div>
 <h4 className="text-base font-black uppercase tracking-tight">Global Support</h4>
 <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">24/7 Hotline Service</p>
 </div>
 </div>
 <div 
 onClick={() => createSupportRequest('Bug Report')}
 className="p-6 bg-slate-50 text-text-primary border border-slate-100 rounded-[2rem] shadow-xl shadow-slate-100 relative overflow-hidden group cursor-pointer min-h-[160px] flex flex-col justify-between"
 >
 <div className="absolute top-0 right-0 w-32 h-32 bg-primary/10 rounded-full -mr-16 -mt-16 blur-2xl" />
 <Zap className="w-10 h-10 mb-4 text-primary " />
 <div>
 <h4 className="text-base font-black uppercase tracking-tight">Report Issue</h4>
 <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Direct feedback node</p>
 </div>
 </div>
 </div>
 
 <div 
 onClick={() => window.location.href = 'mailto:support@restaurant.com'}
 className="p-6 bg-white rounded-3xl border border-slate-100 flex items-center justify-between group cursor-pointer shadow-sm"
 >
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 bg-primary/5 rounded-xl flex items-center justify-center text-primary"><Mail className="w-6 h-6" /></div>
 <div>
 <p className="text-xs font-black uppercase tracking-tight leading-none">Email Us</p>
 <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-1.5">support@restaurant.com</p>
 </div>
 </div>
