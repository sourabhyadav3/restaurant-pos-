...
const CustomerCart = () => {
 ...
 if (orderSuccess) {
 return (
 <div className="flex flex-col items-center justify-center h-[70vh] text-center px-6 animate-in fade-in zoom-in ">
 ...
 className="mt-8 btn-primary px-10 py-4 rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-primary/20 "
 >
 Browse Menu
 </button>
 </div>
 ...
 {cartItems.map((item) => (
 <div key={item.id} className="card p-4 lg:p-5 bg-white border-none shadow-xl shadow-slate-100/50 flex gap-4 lg:gap-6 group ">
 <div className="w-20 h-20 lg:w-24 lg:h-24 bg-slate-50 rounded-2xl flex items-center justify-center text-4xl shadow-inner group- ">
 {item.image}
 </div>
 <div className="flex-1 flex flex-col justify-between">
 <div>
 <div className="flex justify-between items-start">
 <h4 className="font-black text-text-primary text-sm lg:text-base uppercase tracking-tight leading-none mb-1 ">{item.name}</h4>
 <button 
 ...
 {/* Coupon Section */}
 <div className="card p-5 lg:p-6 bg-emerald-50 border-2 border-dashed border-emerald-200 rounded-[2rem] flex items-center justify-between group cursor-pointer ">
 ...
 disabled={isOrdering}
 className="w-full btn-primary py-4 lg:py-5 rounded-2xl lg:rounded-3xl flex items-center justify-center gap-3 text-sm font-black uppercase tracking-widest shadow-2xl shadow-primary/30 group disabled:opacity-50"
 >
